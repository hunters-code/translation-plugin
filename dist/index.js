...
export default definePluginEntry({
    ...
    async register(api) {
        ...
        api.registerTool({
            ...
            description: "Menerjemahkan string ke bahasa target; sumber bisa auto. Butuh koneksi ke endpoint LibreTranslate.",
        ...
        api.registerTool({
            ...
            label: "Daftar bahasa",
            description: "Bahasa yang didukung server terjemahan (kode + nama) untuk memilih target translate",
